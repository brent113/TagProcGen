...
namespace TagProcGen
{
    ...
    public static class GenTags
    {
        ...
        public static void Generate(string path)
        {
            ...
            {
                Interaction.MsgBox("Could not successfully generate tag map. Error text:" + Microsoft.VisualBasic.Constants.vbCrLf + Microsoft.VisualBasic.Constants.vbCrLf + ex.Message + Microsoft.VisualBasic.Constants.vbCrLf + Microsoft.VisualBasic.Constants.vbCrLf + "Occured while: " + Processing, MsgBoxStyle.Critical, "Error");
                return;
            }
            finally
            {
            ...
            Interaction.MsgBox("Successfully generated tag processor map." + Microsoft.VisualBasic.Constants.vbCrLf + Microsoft.VisualBasic.Constants.vbCrLf + "Longest SCADA tag name: " + TPL_Scada.MaxValidatedTag + " at " + Conversions.ToString(TPL_Scada.MaxValidatedTagLength) + " characters.", MsgBoxStyle.Information, "Success");
        }
